 ...
 * shared VitaLink Device, not a secret. The PIN is the secret, so it is never shown.
 */
    ...
    <div className="card usercode-card">
      ...
      <div>
        <ol className="usercode-steps">
          <li>
            At the VitaLink Device, type your User ID <strong>{userCode}</strong> and press <strong>#</strong>.
          </li>
          <li>
          ...
          <li>
            Press <strong>A</strong> when you are done. The VitaLink Device also logs you out on its own
        ...
        <p className="usercode-note">
          {deviceOnline
            ...
            : 'The VitaLink Device is offline right now. It needs to be switched on and connected to WiFi before anyone can log in at the keypad.'}
        </p>
      </div>
    </div>
  );
